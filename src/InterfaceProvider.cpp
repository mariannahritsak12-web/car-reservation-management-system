...
ConsoleInterfaceProvider::ConsoleInterfaceProvider(Kalendarz &k, KatalogSamochodow &kat, Uzytkownicy &u, ListaRezerwacji &rez, Administrator &admin, Pracownik &prac) : kalendarz(k), katalog(kat), uzytkownicy(u), rezerwacje(rez), administrator(admin), pracownik(prac) {}
...
void ConsoleInterfaceProvider::wyswietlMenuPracownika()
{
    ...
    while (wybor != 0)
    {
        ...
        case 1:
        {
            ...
            cout << "Podaj date poczatku rezerwacji(RRRR-MM-DD): ";
            cin >> dataStart;
            cout << "Podaj date zakonczenia rezerwacji(RRRR-MM-DD): ";
            cin >> dataKoniec;
...
void ConsoleInterfaceProvider::submenuZarzadzajFlota()
{
    ...
    while (wybor != 0)
    {
        ...
        case 1:
        {
            int idSamochodu = pobierzLiczbe("Wpisz ID samchodu: ");
...
void ConsoleInterfaceProvider::submenuZarzadzajDokumentacja()
{
    ...
    while (wybor != 0)
    {
        ...
        cout << "3. Wysiwetl dokumentacje dla samochodu" << endl;
        ...
        switch(wybor) {
        case 1:
            // TO-DO: zaimplementowaæ logikê dodawania dokumnetacji do konkretnego samochodu
            break;
        case 2:
            //administrator.przegladajDokumenty()
            break;
        }
    }
}
...
void ConsoleInterfaceProvider::submenuZarzadzajRezerwacjami()
{
    ...
    case 1:
        {
        int idRez = pobierzLiczbe("Podaj ID rezerwacji do usuniecia: ");

        administrator.usunRezerwacje(rezerwacje, idRez);
        cout << "Rezerwacja zostala usunieta pomyslnie!" << endl;
        break;
        }
    case 2:
        administrator.przegladajRezerwacje(rezerwacje);
        break;
    }
  }
}
